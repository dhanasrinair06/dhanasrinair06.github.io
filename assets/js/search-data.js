...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/office-hours/";
          },
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-introducing-office-hours-if-you-re-curious-about-regulatory-affairs-thinking-about-switching-into-it-or-just-want-to-talk-about-the-work-you-can-now-book-a-30-minute-slot-with-me",
          title: 'Introducing Office Hours! If you’re curious about regulatory affairs, thinking about switching into...',
          description: "",
          section: "News",},{
        id: 'social-email',
        title: 'email',
